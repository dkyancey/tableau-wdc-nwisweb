...
(function() {
	...
	myConnector.getData = function(table, doneCallback) {
		var formObj = JSON.parse(tableau.connectionData),
		    ...
		    apiCall="https://waterservices.usgs.gov/nwis/iv/?format=json&sites=" + formObj.Site_no + "&startDT=" +  formObj.startDate + "T0:0:00.000&endDT=" +  formObj.endDate + "T23:59:59.000&parameterCd=" + formObj.Parms + "&siteStatus=all";
